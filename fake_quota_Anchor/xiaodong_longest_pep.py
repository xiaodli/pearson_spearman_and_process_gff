...
def processing_pep(raw_pep_file, gff_file, longest_pep_file):

    trans_list = xiao_read_gff_get_longest.read_gff(gff_file)
    seqs = []
    # n = 0
    for seq_record in SeqIO.parse(raw_pep_file, "fasta"):
    ...
    SeqIO.write(seqs, longest_pep_file, "fasta")
    # print(n)


if __name__ == '__main__':
    parser = ArgumentParser(description="This is a longest_pep from raw_pep_file")
